...
path = "/mnt/c/Users/kevin/Documents/wpi_course_materials/DS502/DS502_team_one/Data/data_almost_analysis_ready.csv"
data = pd.read_csv(path)
# %%
target = "MELANCHOLIC_TYPE"
clinical_measures = [
    "sBCog45S",
    "sBNeg45S",
    "sBSoc45S",
...
info_df = pd.DataFrame(columns=["pipeline", "n_pca", "penalty", "num_features_selected", "cv_scores", "mean_score", "std_score"])
